export default function Privacy() {
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <p>⊳ You have to vote for the <a className="text-white" href="https://top.gg/bot/924325576095973426/vote">Flaxis</a> bot when using certain commands from the bot commands.</p>
        <div className="py-3"></div>
        <p>⊳ Every user can use the Flaxis bot however they want, as long as they do not intend to harm.</p>
        <div className="py-3"></div>
        <p>⊳ You cannot use certain commands at the same time while using Flaxis.</p>   
        <div className="py-3"></div>
        <p>⊳ Flaxis bot does not save any data based on users.</p>
        <div className="py-3"></div>
